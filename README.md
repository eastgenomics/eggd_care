...
4. **Upload output** - Upload the output folders and subfolders into DNA Nexus and returned a job's output array files.
...
The results are stored in a the folder outputs/<SAMPLE_ID>.
Several files are created. Among these, to find the outlier genes:
