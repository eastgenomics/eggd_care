...
|---|---|---|
| `eggd_treehouse_expression_folder` | string | Folder path name for expression results outputted by eggd_treehouse_pipeline. Essential files: /rsem_genes.results, QC/STAR/Log.final.out, QC/fastQC/R1_fastqc.html Optional file for isoforms analysis: RSEM/rsem_isoforms.results.
